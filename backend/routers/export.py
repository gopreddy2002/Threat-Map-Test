...
def _export_pdf(scan: Scan):
    ...
    elements.append(Paragraph("<b>Heads up:</b> AI Analyst Briefs are generated by AI and can make mistakes. Please double check important information.", warning_style))
    ...
    def add_page_styling(canvas, doc):
        ...
        canvas.drawString(40, 20, "Trusted by ThreatMap - Automated Threat Intelligence")
        canvas.restoreState()
